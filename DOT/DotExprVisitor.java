...
public interface DotExprVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by the {@code GraphBody}
	 * labeled alternative in {@link DotExprParser#graph}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGraphBody(DotExprParser.GraphBodyContext ctx);
	/**
	 ...
	 * labeled alternative in {@link DotExprParser#a_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAList(DotExprParser.AListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link DotExprParser#edgeop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEdgeop(DotExprParser.EdgeopContext ctx);
	/**
	 * Visit a parse tree produced by {@link DotExprParser#sep}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSep(DotExprParser.SepContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link DotExprParser#id_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitId_(DotExprParser.Id_Context ctx);
}