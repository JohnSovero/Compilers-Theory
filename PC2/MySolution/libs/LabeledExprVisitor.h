...
public:
   ...
   */
    ...
    virtual std::any visitDefTop(LabeledExprParser::DefTopContext *context) = 0;

    virtual std::any visitExternTop(LabeledExprParser::ExternTopContext *context) = 0;

    virtual std::any visitDef(LabeledExprParser::DefContext *context) = 0;

    virtual std::any visitPrototypeExpr(LabeledExprParser::PrototypeExprContext *context) = 0;

    virtual std::any visitExtern(LabeledExprParser::ExternContext *context) = 0;
